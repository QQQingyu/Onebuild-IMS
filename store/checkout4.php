            ...
            <div id="checkout" class="col-lg-9">
              <div class="box">
                <form method="post" action="order.php">
                      ...
                      <tbody>
                        ...
                        <tfoot>
                          <tr>
							...
							<input type="hidden" value=" <? echo $payment  ?>"  name="payment">
                          </tr>
                        </tfoot>
                      </table>
                    </div>
                  ...
                  <!-- /.content-->
                  <div class="box-footer d-flex justify-content-between"><a href="javascript:history.go(-1)" class="btn btn-outline-secondary"><i class="fa fa-chevron-left"></i>Back to payment method</a>
