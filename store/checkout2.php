            ...
            <div id="checkout" class="col-lg-9">
              <div class="box">
                <form method="post" action="checkout3.php">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="box shipping-method">
                          ...
                          <div class="box-footer text-center">
                            <input type="radio" name="delivery" value="sf-express" checked="true">
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                      ...
                      <div class="col-md-6">
                        <div class="box shipping-method">
                          ...
                          <p>Get it right on next day - fastest option possible.</p>
                          <div class="box-footer text-center">
                            <input type="radio" name="delivery" value="sto-express">
                  ...
                  <div class="box-footer d-flex justify-content-between"><a href="javascript:history.go(-1)" class="btn btn-outline-secondary"><i class="fa fa-chevron-left"></i>Back to address</a>
