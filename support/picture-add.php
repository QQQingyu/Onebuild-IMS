   ...
   <div class="type_title">Adding product</div>
	<form action="adding.php" method="post" class="form form-horizontal" id="form-article-add" enctype="multipart/form-data">
		...
		<div class="clearfix cl">
		 ...
		 <div class="formControls col-10"><input type="text" class="input-text" value="0" placeholder="" id="Inventory" name="Inventory"></div>
		</div>
						<div class="clearfix cl">
         <label class="form-label col-2"><span class="c-red">*</span>State：</label>
		
		 <input type="radio" name="state" value="1" checked>Active
