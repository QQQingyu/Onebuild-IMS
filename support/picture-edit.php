...
//$sql = "INSERT INTO product (id, name, price, pic, description, state,inventory) 
	//		 VALUES ('$num', '$name', '$price', '$pic_path' , '$content','$state', '$inventory');" ;
?>

   <div class="type_title">Edit product</div>
	<form action="product_edit.php" method="post" class="form form-horizontal" id="form-article-add" enctype="multipart/form-data">
		<div class="clearfix cl">
         <label class="form-label col-2"><span class="c-red">*</span>Name：</label>
		 <div class="formControls col-10"><input type="text" class="input-text" value="<?php echo $sql_arr['name']?>" placeholder="" id="Name" name="Name"></div>
		</div>
		<div class="clearfix cl">
         <label class="form-label col-2"><span class="c-red">*</span>No：</label>
		 <div class="formControls col-10"><input type="text" class="input-text" value="<?php echo $sql_arr['id']?>" placeholder="" id="num" name="num"></div>
		</div>
		<div class="clearfix cl">
         <label class="form-label col-2"><span class="c-red">*</span>Price：</label>
		 <div class="formControls col-10"><input type="text" class="input-text" value="<?php echo $sql_arr['price']?>" placeholder="" id="Price" name="Price"></div>
		</div>
				<div class="clearfix cl">
         <label class="form-label col-2"><span class="c-red">*</span>Inventory：</label>
		 <div class="formControls col-10"><input type="text" class="input-text" value="<?php echo $sql_arr['inventory']?>" placeholder="" id="Inventory" name="Inventory"></div>
		</div>
						<div class="clearfix cl">
         <label class="form-label col-2"><span class="c-red">*</span>State：</label>
		 <input type="hidden"  value="<?php echo $sql_arr['id']?>" placeholder="" id="num" name="num">
		
		 <input type="radio" name="state" value="<?php echo $sql_arr['state']?>" checked>Active
<input type="radio" name="state" value="0">inactive
		</div>
...
<input value="<?php echo $sql_arr['pic']?>" type="hidden" name="picture" >
         ...
         <label class="form-label col-2">Description：</label>
			<div class="formControls col-10">
				<script id="editor" name="content" type="text/plain" style="width:100%;height:400px;" ><?php echo $sql_arr['description']?></script> 
             </div>
        </div>
